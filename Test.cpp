...
TEST_CASE("Addition test ") {
        ...
        ariel::Fraction f5 = f1 + f2;
        CHECK(f3.getNumerator() == 29);
        CHECK(f3.getDenominator() == 35);
        CHECK(f5.getNumerator() == -1);
        CHECK(f5.getDenominator() == 35);

        ariel::Fraction f7(2, 5);
        float num = 1.25;
        ariel::Fraction f8 = num + f7;
        CHECK(f8.getNumerator() == 9);
        CHECK(f8.getDenominator() == 4);
        ariel::Fraction f9(-2, 5);
        float num2 = -1.25;
        ariel::Fraction f10 = num + f9;
        CHECK(f10.getNumerator() == -9);
        CHECK(f10.getDenominator() == 4);
        ariel::Fraction f11(2, 5);
        float num3 = 1.25;
        ariel::Fraction f12 = f11 + num;
        CHECK(f12.getNumerator() == 9);
        CHECK(f12.getDenominator() == 4);
}
